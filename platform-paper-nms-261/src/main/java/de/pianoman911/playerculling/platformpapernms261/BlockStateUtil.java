package de.pianoman911.playerculling.platformpapernms261;
...
public final class BlockStateUtil {
    ...
    private static boolean boxContainsBox(AABB outer, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {

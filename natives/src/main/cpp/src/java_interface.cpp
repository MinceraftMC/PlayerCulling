...
occlusion_instance *create_occlusion_instance(dynamic_world *dynamic_world) {
...
bool cpp_occlusion_instance_is_aabb_visible(const occlusion_instance *instance, const double min_x, const double min_y,
                                            const double min_z,
                                            const double max_x, const double max_y, const double max_z,
                                            const double viewer_x,
...
void cpp_occlusion_instance_update_world(occlusion_instance *instance, const int32_t ccx, const int32_t ccz,
                                         WorldCache *world) {
    instance->update_world(ccx, ccz, world);
}
}
